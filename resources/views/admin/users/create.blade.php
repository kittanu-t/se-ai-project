...
<div class="container-fluid py-4" style="background-color: #f8f9fa; min-height: 100vh;">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h1 class="text-center text-dark mb-4">Create User</h1>
            ...
            <div class="card p-4 shadow-sm rounded-4">
                <form method="POST" action="{{ route('admin.users.store') }}" class="needs-validation">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required class="form-control" id="name" style="border: 1px solid #6C757D; border-radius: 8px;">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" required class="form-control" id="email" style="border: 1px solid #6C757D; border-radius: 8px;">
                        @error('email')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="phone" value="{{ old('phone') }}" class="form-control" id="phone" style="border: 1px solid #6C757D; border-radius: 8px;">
                        @error('phone')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" name="password" required class="form-control" id="password" style="border: 1px solid #6C757D; border-radius: 8px;">
                        @error('password')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" name="password_confirmation" required class="form-control" id="password_confirmation" style="border: 1px solid #6C757D; border-radius: 8px;">
